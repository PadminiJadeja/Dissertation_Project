...
# frames_UCSDPed2 contains the ground truth for each test video in UCSDPed2 dataset separated by new line
with open('frames_UCSDPed2') as f:
    lines = [line.rstrip('\n') for line in f]

# fetching the frame ranges
rang=[x.split(',') for x in lines]

#Frame ranges in frames_UCSDPed2 is stored in form of a:b, so

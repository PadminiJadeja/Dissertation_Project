...
# frames_Avenue contains the ground truth for each test video in Avenue dataset separated by new line
with open('frames_Avenue') as f:
    lines = [line.rstrip('\n') for line in f]

# fetching the frame ranges
rang=[x.split(',') for x in lines]

#Frame ranges in frames_Avenue is stored in form of a:b, so
